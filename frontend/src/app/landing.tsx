...
export default function Landing() {
    ...
    return (
        <div className="flex ">
            <div className="w-full lg:w-3/5 p-4 bg-white dark:bg-violet-900 text-white font-bold">
                <div className="text-center py-72 text-[32px]">
                    Welcome to Taskhub
                </div>
            </div>
            <div className="w-full lg:w-2/5 h-full bg-white text-black">
                <div className="bg-violet-500 py-24 lg:py-72 xl:py-96 dark:bg-black text-white">
                        ...
                        <h2 className="text-center text-[20px] leading-[1.2] md:text-[32px] md:leading-8">
                            ...
                            <div className="mt-5 w-full max-w-[440px]">
                                <div className="grid gap-x-3 gap-y-2 sm:grid-cols-2 sm:gap-y-0">
                                    <button className="relative flex h-12 items-center justify-center rounded-md text-center text-base font-medium bg-[#3C46FF] text-[#fff] hover:bg-[#0000FF]" onClick={handleClick}>
                                        Login
                                    </button>
